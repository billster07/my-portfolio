                ...
                >
                  ...
                  <div className="flex-1 p-6">
                    <Link href={`/articles/${article.slug}`}>
                      <h3 className="text-2xl font-bold leading-tight text-zinc-900 dark:text-black-50  py-4">
                        {article.title}
                      </h3>
                    </Link>
                    ...
                    <p className="max-w-none text-zinc-600 mt-2 mb-2 text-sm font-bold dark:text-black-400">
                      Written by: {article.authorName}
                    </p>
                    <div className="flex justify-end">
                      <Link
                        className="inline-flex h-10 items-center justify-center text-sm text-black font-medium"
